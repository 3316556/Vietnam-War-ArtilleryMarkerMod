# Configure Artillery Marker Mod

No MelonPreferences config is required. In game, F8 toggles shell-follow behavior on/off. If FPS Counter is also installed, both mods currently use F8.
